...
import type { StatusData, StatusResponse, StreamEventsData, InvokeToolData, InvokeToolError, CallbackData, CallbackError, PollFlowData, PollFlowResponse, PollFlowError, StartFlowData, StartFlowResponse2, StartFlowError, DeleteTokensData, DeleteTokensError, GetTokensData, GetTokensError, SetTokensData, SetTokensError, SessionCommandHistoryData, SessionCommandHistoryResponse, SessionCommandHistoryError, SessionCommandData, SessionCommandResponse, SessionCommandError, SessionContextData, SessionContextResponse, SessionContextError, ListApplicationsData, ListApplicationsResponse, ListApplicationsError, OpenApplicationData, OpenApplicationResponse2, OpenApplicationError, ListExtensionsData, ListExtensionsResponse, OpenExtensionData, OpenExtensionError } from './types.gen';
...
/**
 * Subscribe to real-time server events via SSE. Optionally filter by session_id.
 */
 ...
 */
export const sessionCommandHistory = <ThrowOnError extends boolean = false>(options?: Options<SessionCommandHistoryData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<SessionCommandHistoryResponse, SessionCommandHistoryError, ThrowOnError>({
        url: '/session/command',
        ...options
    });
};
...
/**
 * Enqueue a message for asynchronous session runtime processing.
 */
export const sessionCommand = <ThrowOnError extends boolean = false>(options: Options<SessionCommandData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<SessionCommandResponse, SessionCommandError, ThrowOnError>({
