...
#[tauri::command]
pub fn plan_command(app: tauri::AppHandle, request: PlanRequest) -> PlanResponse {
...
#[tauri::command]
pub fn run_workflow(app: tauri::AppHandle, request: WorkflowRunRequest) -> WorkflowRunResponse {
    let workflow_schema = load_workflow_schema();
    let command_schema = load_command_schema();
    let mut workflows = Vec::new();
    let mut commands = Vec::new();
...
#[tauri::command]
pub fn list_commands(app: tauri::AppHandle) -> CommandLoadResponse {
...
#[tauri::command]
pub fn save_command(app: tauri::AppHandle, request: CommandWriteRequest) -> CommandWriteResponse {
    let schema = load_command_schema();
...
#[tauri::command]
pub fn delete_command(app: tauri::AppHandle, request: CommandDeleteRequest) -> CommandDeleteResponse {
    let Some(dir) = user_commands_dir(&app) else {
...
#[tauri::command]
pub fn list_workflows(app: tauri::AppHandle) -> WorkflowLoadResponse {
...
#[tauri::command]
pub fn save_workflow(app: tauri::AppHandle, request: WorkflowWriteRequest) -> WorkflowWriteResponse {
    let schema = load_workflow_schema();
...
#[tauri::command]
pub fn delete_workflow(app: tauri::AppHandle, request: WorkflowDeleteRequest) -> WorkflowDeleteResponse {
    let Some(dir) = user_workflows_dir(&app) else {
