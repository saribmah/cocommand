...
pub use config::{
    ...
    ExtensionCachePreferences, SessionPreferences, WorkspaceConfig, WorkspaceExtension,
    WorkspaceExtensions, WorkspaceLLMPreferences, WorkspacePreferences, WorkspaceTheme,
